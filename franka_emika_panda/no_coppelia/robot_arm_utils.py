...
def compute_arm_error_minimization_inverse_kinematics_no_coppelia(
        q_first_guess:list, end_effector_des_start_pose:list,  franka_dh_params: list,  world_T_0: np.ndarray, q0_W : np.ndarray,  q_des_list: list) -> np.ndarray:
    ...
    for i in range(0, len(q_des_list)):
        if i == 0:
            ...
            end_effector_des_start[0:3,0:3] = end_effector_des_start_pose[0:3,0:3]
