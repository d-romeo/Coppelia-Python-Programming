...
if __name__ == "__main__":
    ...
    # File parameters
    file_name = 'sim-coppelia-finali/cr-de/avanti_indietro.xlsx'
    ...
    arm_trajecotry_chiara = []             # desired trajectory 
    ...
    q_ik_list_ctt = compute_inverse_kinematics(sim, target_handle=target_handle, franka_joint_handles=franka_joint_handles,franka_dh_params=franka_dh_params, arm_trajecotry=arm_trajecotry_chiara, include_orientation=False, arm_poses=arm_poses, world_T_0=world_T_0)
    ...
    if hjtt == True: 
        ...
        save_traj_to_excel(
            ...
            path="sim-coppelia-finali/risultati/smf/traj_smf_hjtt.xlsx"
        )
        #save_q_to_excel_arm(q_arm_sim_hjtt, "sim-coppelia-finali/cr-de/q_arm_hjtt.xlsx", "arm")
        ...
        #save_q_to_excel_arm(q_arm_sim_ctt, "sim-coppelia-finali/cr-de/q_arm_ctt.xlsx", "arm")
        save_traj_to_excel(
            traj=end_effector_trajectory,
            path="sim-coppelia-finali/risultati/smf/traj_smf_ctt.xlsx"
        )
